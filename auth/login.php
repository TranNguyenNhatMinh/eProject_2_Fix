                    ...
                    <div class="auth-bar">
                        ...
                        <div class="auth-bar-right">
                            ...
                            <div class="auth-footer">
                                <?php $regUrl = 'register.php' . (isset($_GET['redirect']) ? '?redirect=' . urlencode($_GET['redirect']) : ''); ?>
                                <p class="mb-0">Don't have an account? <a href="<?php echo htmlspecialchars($regUrl); ?>" class="auth-link">Sign Up Now</a></p>
                            </div>
                        </div>
                    </div>
                </div>
